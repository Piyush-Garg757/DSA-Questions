...
Find any permutation b of length n such that
...
The first line of input contains a single integer t (1 ≤ t ≤ 2000) — the number of test cases.
...
a1, a2, …, an
(1 ≤ ai ≤ n) — the elements of permutation a.
All elements of a are distinct.
Note that there is no bound on the sum of n over all test cases.

Output
For each test case, output any permutation b which satisfies the constraints mentioned in the statement.
It can be proven that a permutation b that satisfies the condition above always exists.
